...
$RLE^{15}_{y=i}$, where $i=1950, 1954... 2100$

See also Figure 2 where again black points represent known data and red the interpolated. 

This two-step procedure was repeated also for men and women separately, which produces three of the variables in the final dataset called **female**, **male** and **total**.
